        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('new_thread_form')
                    ...
                    ->end()
                ->end()
            ->arrayNode('new_thread_multiple_form')
                ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('factory')->defaultValue('fos_message.new_thread_multiple_form.factory.default')->cannotBeEmpty()->end()
                        ->scalarNode('type')->defaultValue('fos_message.new_thread_multiple_form.type.default')->cannotBeEmpty()->end()
                        ->scalarNode('handler')->defaultValue('fos_message.new_thread_multiple_form.handler.default')->cannotBeEmpty()->end()
                        ->scalarNode('name')->defaultValue('message')->cannotBeEmpty()->end()
                        ->scalarNode('model')->defaultValue('FOS\MessageBundle\FormModel\NewThreadMultipleMessage')->end()
                    ->end()
                ->end()
